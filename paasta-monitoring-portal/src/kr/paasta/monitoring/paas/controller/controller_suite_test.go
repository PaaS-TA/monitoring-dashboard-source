...
var _ = Describe("Controller BeforeSuite", func() {
	...
	BeforeSuite(func() {
		...
		config, err := readConfig(`/home/ubuntu/gitpaas5.1/PaaS-TA-Monitoring/paasta-monitoring-portal/src/kr/paasta/monitoring/config.ini`)
		if err != nil {
		...
		xmlFile, err := ReadXmlConfig(`/home/ubuntu/gitpaas5.1//PaaS-TA-Monitoring/paasta-monitoring-portal/src/kr/paasta/monitoring/log_config.xml`)
		if err != nil {
			log.Println(err)
			os.Exit(-1)
		}
