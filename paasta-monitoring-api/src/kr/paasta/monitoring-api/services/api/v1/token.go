...
// Refresh 토큰 정리 후 적용
func (h *TokenService) CreateToken(apiRequest v1.UserInfo, c echo.Context) (v1.TokenDetails, error) {
...
func (h *TokenService) RefreshToken(apiRequest v1.TokenDetails, c echo.Context) (v1.TokenDetails, error) {
