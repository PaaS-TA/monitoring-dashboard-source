...
func (common *AlarmPolicyController) GetAlarmPolicy(c echo.Context) error {
...
func (common *AlarmPolicyController) UpdateAlarmPolicy(c echo.Context) error {
...
func (common *AlarmPolicyController) UpdateAlarmTarget(c echo.Context) error {
