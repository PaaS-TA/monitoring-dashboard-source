...
import (
	...
	"paasta-websocket/zabbix-client/common"
	"paasta-websocket/zabbix-client/history"
	"paasta-websocket/zabbix-client/host"
	"paasta-websocket/zabbix-client/item"
...
func (zabbixService *ZabbixService) getHostIpAddress(req *http.Request, instanceId string) string {
	...
	computeClient, _ := utils.GetComputeClient(zabbixService.OpenstackProvider, "RegionOne")
