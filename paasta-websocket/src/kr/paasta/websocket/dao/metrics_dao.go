...
func (b serverDtvMetricStruct) GetTopProcessList(request model.MetricsRequest) (_ client.Response, errMsg model.ErrMessage) {
	var errLogMsg string
	defer func() {
		if r := recover(); r != nil {
...
func (b serverDtvMetricStruct) GetApplicationResourcesAll(request model.MetricsRequest) (_ client.Response, errMsg model.ErrMessage) {
...
func (b serverDtvMetricStruct) GetAppCpuUsage(request model.MetricsRequest) (_ client.Response, errMsg model.ErrMessage) {
	var errLogMsg string
	defer func() {
		if r := recover(); r != nil {
...
func (b serverDtvMetricStruct) GetAppMemoryUsage(request model.MetricsRequest) (_ client.Response, errMsg model.ErrMessage) {
	var errLogMsg string
	defer func() {
		if r := recover(); r != nil {
...
func (b serverDtvMetricStruct) GetAppDiskUsage(request model.MetricsRequest) (_ client.Response, errMsg model.ErrMessage) {
