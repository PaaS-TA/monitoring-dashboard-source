...
type (
	...
	//BatchAlarmConfig struct {
	//	ConfigId       string `gorm:"type:varchar(50);not null;primary_key"`
	//	ConfigValue    string `gorm:"type:varchar(1000);not null"`
	//	ConfigDescript string `gorm:"type:varchar(1000);null"`
	//}
	//
	//AlarmRequest struct {
	//	Nodename      string `json:"nodename"`
