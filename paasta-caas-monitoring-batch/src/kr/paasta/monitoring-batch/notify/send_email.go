...
func buildMailMessage(mailContent model.MailContent) string {
	...
	//mailForm += "#text_area p strong:before{display:inline-block;content:'';width:23px;height:24px;background:url(" + resourceUrl + "/public/resources/img/email/ic_error.png) no-repeat;background-size:100%;vertical-align:bottom;margin-right:7px;}"
	mailForm += "</style>"
	mailForm += "</head>"
	...
	mailForm += "                <h2 style=\"margin:0;padding:0;font-family:'Noto Sans', sans-serif;font-size:12px;color:#555;\"><img src=\"" + resourceUrl + "/public/resources/img/email/logo.png\" alt=\"monitorxpert\" style=\"border:0 none;width:279px;\"></h2>"
	mailForm += "            </div>"
